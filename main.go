...
import (
	...
	rabbitmqv2 "github.com/rabbitmq/cluster-operator/api/v2"
...
func init() {
	...
	_ = rabbitmqv2.AddToScheme(scheme)
...
func main() {
	...
	if err = (&rabbitmqv1beta1.RabbitmqCluster{}).SetupWebhookWithManager(mgr); err != nil {
